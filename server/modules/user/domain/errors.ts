...
// Thrown when a non-approved account attempts an action that would spend the operator key.
// Carries the access state so the API/UI can distinguish pending vs blocked.
