...
Build a Spanish-language learning SPA from scratch in [/Users/forfold/git/guess-and-correct/](/Users/forfold/git/guess-and-correct/). The user is shown a Spanish sentence in the center of the screen, types an English translation, submits, and the app reveals the correct answer plus a per-word breakdown of mistakes (including which Spanish source words they misunderstood). A "Next" button advances to a new sentence.
...
| Concern                     | Choice                                                                                                                             | Why                                                                                                                                                                                                                                                                                                   |
| --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Frontend build              | Vite 7 + React 19 + TypeScript                                                                                                     | mirrors [/Users/forfold/git/forfold/](/Users/forfold/git/forfold/)                                                                                                                                                                                                                                    |
...
| ORM                         | Drizzle                                                                                                                            | matches [/Users/forfold/git/ehs-form-consumer/](/Users/forfold/git/ehs-form-consumer/)                                                                                                                                                                                                                |
...
- **Vite/React/MUI scaffold + ESLint/Prettier** — copy from [/Users/forfold/git/forfold/vite.config.ts](/Users/forfold/git/forfold/vite.config.ts), [/Users/forfold/git/forfold/eslint.config.js](/Users/forfold/git/forfold/eslint.config.js), [/Users/forfold/git/forfold/prettier.config.cjs](/Users/forfold/git/forfold/prettier.config.cjs), [/Users/forfold/git/forfold/tsconfig.json](/Users/forfold/git/forfold/tsconfig.json). Same versions for the scaffold (React 19.2, Vite 7.1, TS 5.9), but **upgrade MUI to 9.0.1** (latest) — forfold is on 7.3, so import paths and a few prop shapes may differ; check Drawer, Select, and Chip when wiring up the sidebar and correction display.
- **Anthropic SDK server-side pattern** — mirror [/Users/forfold/git/ehs-form-consumer/src/app/api/extract/route.ts](/Users/forfold/git/ehs-form-consumer/src/app/api/extract/route.ts) (per-request SDK instance, model `claude-sonnet-4-6`, structured JSON output, try/catch + log + 500). Modified here: API key is per-user decrypted, not from env.
